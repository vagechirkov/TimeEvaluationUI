...
namespace TimeEvaluationUI.Runtime {
  public class DragDrop : MonoBehaviour,
    ...
    public void OnDrag(PointerEventData eventData) {
      ...
      if (Mathf.Abs(magnitude - ScaleRadius) < PositionPrecisionError &&
          angle < 180f && angle > 0)
    ...
    public void OnEndDrag(PointerEventData eventData) {
      ...
      if (Mathf.Abs(magnitude - ScaleRadius) < PositionPrecisionError &&
        ...
        _rectTransform.anchoredPosition =
            StartPosition + GetPositionOnCircle(angle + 180f);
    ...
    void OnGUI() {
      if (Response != 0)
        GUI.Label(new Rect(50, 25, 300, 20),
                  "Response: " + (int)Response + " ms", guiStyle);
    }
  }
}